...
- [x] إزالة حركة الصندوق من صفحات العميل وواجهة دفعات العميل، والإبقاء عليها فقط في Finances الصفحة الأساسية.
- [x] إضافة قسم ديون مستقل لكل عميل، مع تسجيل الرصيد والمتابعة دون خلطه بحركة الصندوق.
- [x] إنشاء صفحة إعدادات مستقلة لقاعدة الاحتفاظ «Suppression et délai» وإرجاع إعدادات البرنامج المحذوفة.
- [x] إعادة «Nomenclature d’activité / Registre de commerce» إلى Réglages du programme مع الإدارة اليدوية المناسبة.
- [x] اختبار العزل والواجهة والبيانات ثم مزامنة التغييرات كاملةً مع GitHub.
...
- [x] تدقيق جميع صفحات ومكوّنات الإعدادات ومساراتها وأشرطة التنقل المرتبطة بها.
- [x] إزالة أيقونة أو رابط Fiche/Clients غير المطلوب من أشرطة الإعدادات فقط، مع عدم حذف صفحة Dossiers من النظام.
- [x] توحيد شريط الإعدادات في الشكل والأيقونات والمسافات والتجاوب على جميع الصفحات.
- [x] اختبار جميع صفحات الإعدادات وحفظ الإصلاح ومزامنته مع GitHub.

- [x] جعل Statut داخل Documents du dossier قائمة منسدلة موحدة ومتصلة بـ documentStatus.
- [x] تمكين إضافة وتعديل وأرشفة واستعادة حالات المستندات من Réglages du programme مع تحديث القائمة دون إعادة تحميل.
- [x] اختبار حفظ حالات المستندات وعزل خيارات documentStatus ثم التحقق والبناء والمزامنة.
