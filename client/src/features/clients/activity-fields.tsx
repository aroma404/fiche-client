...
const domainChoices = [{ value: "", label: "Choisir le domaine" }, { value: "Agriculture", label: "Agriculture" }, { value: "Artisanat", label: "Artisanat" }, { value: "Auto-entrepreneur", label: "Auto-entrepreneur" }, { value: "Registre de commerce", label: "Registre de commerce" }];
