...
async function createStyledExcelArchive(payload: ExportPayload) {
  ...
  const tables: [string, string, string, ArchiveRow[], string[], number[]][] = [["Clients", "DOSSIERS CLIENTS", "Identité, activité et références fiscales", clientRows, ["Clé dossier", "Nom / raison sociale", "Activité", "Domaine d’activité", "Type d’auto-entreprise", "Catégorie RC", "Code activité RC", "Forme juridique", "Type de client", "Statut", "Commune", "Contact", "NIF", "N° RC", "BP", "Article d’imposition", "NIN", "Régime fiscal", "Centre d’impôt", "Solde initial (DA)", "Observations financières"], [12, 30, 30, 24, 24, 22, 20, 20, 18, 14, 18, 20, 16, 14, 12, 20, 16, 22, 18, 18, 36]], ["Documents", "DOCUMENTS", "Pièces et statut documentaire", docs, ["Clé dossier", "Document", "Catégorie", "Statut", "Observation"], [12, 28, 18, 16, 42]], ["Conformité", "CONFORMITÉ", "Obligations sociales et administratives", compliance, ["Clé dossier", "Obligation", "Statut", "Note"], [12, 32, 18, 42]], ["Opérations", "OPÉRATIONS CLIENT", "Paiements et caisse liés au client", operations, ["Clé dossier", "Date", "Nature", "Libellé", "Sens", "Référence", "Montant (DA)"], [12, 14, 16, 30, 16, 22, 18]]];
