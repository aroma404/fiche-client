...
async function createStyledExcelArchive(payload: ExportPayload) {
  ...
  const archiveSheetNames = ["Clients", "Contacts", "Documents", "Conformité", "Opérations"];
