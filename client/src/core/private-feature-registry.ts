...
export type PrivateFeatureDefinition = {
  id: "dashboard" | "clients" | "finances" | "transfers" | "archives" | "settings" | "account";
  href: string;
  label: string;
  sectionTitle: string;
  icon: LucideIcon;
...
export const privateFeatureRegistry: readonly PrivateFeatureDefinition[] = [
  ...
  { id: "clients", href: "/clients", label: "Dossiers clients", sectionTitle: "Dossiers clients", icon: Users, prewarm: true, visibleInNavigation: true },
  ...
  { id: "settings", href: "/reglages", label: "Réglages du programme", sectionTitle: "Réglages du programme", icon: Settings2, prewarm: true, visibleInNavigation: true },
